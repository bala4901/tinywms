    ...
    getQuickStart: function() {
        var me = this, ret = {
            ...
            items: [
                ...
                {overflowText: "Settings", tooltip: {text: "Settings", align: 'bl-tl'}, iconCls: "bleext-settings-icon", handler: function() {
                        Bleext.App.showNotification({message: "Testing this notification! this is just a dommy text!"});
                    }}
            ]
        };
