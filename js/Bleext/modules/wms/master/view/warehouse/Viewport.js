...
Ext.define("Bleext.modules.wms.master.view.warehouse.Viewport", {
    ...
    buildItems: function() {
        var form = Ext.create("Bleext.modules.wms.master.view.warehouse.WhForm", {
            region: "east",
            collapsed: true
        });
        var grid = Ext.create("Bleext.modules.wms.master.view.warehouse.WhGrid", {
            region: "center"
        });
