...
Ext.define("Bleext.modules.wms.master.view.area.Viewport", {
    ...
    buildItems: function() {
        var form = Ext.create("Bleext.modules.wms.master.view.area.AreaForm", {
            region: "east",
            collapsed: true
        });
        var grid = Ext.create("Bleext.modules.wms.master.view.area.AreaGrid", {
            region: "center"
        });
